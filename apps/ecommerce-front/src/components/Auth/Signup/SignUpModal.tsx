  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        "
      >
        <div className="shrink-0 bg-gradient-to-r from-primary to-primary/80 p-4 sm:p-6 rounded-t-2xl">
        ...
        <div className="p-4 sm:p-6 bg-white overflow-y-auto flex-1">
          ...
          >
            ...
            >
              <g clipPath="url(#clip0_signup_google)">
                <path
        ...
        <div className="px-6 py-5 border-t border-gray-200 flex justify-end bg-white shrink-0">
          <button
            onClick={handleClose}
            className="
              px-6 py-3
