...
const Signup = () => {
    ...
    try {
      ...
      if (!response?.success) {
        toast.update(toastId, {
          render: response?.message || "Erro ao cadastrar.",
          type: "error",
          isLoading: false,
          autoClose: 3000,
        });
      ...
      toast.update(toastId, {
        render: err?.message || "Erro inesperado.",
        type: "error",
        isLoading: false,
        autoClose: 3000,
      });
  ...
  return (
    <>
      <Breadcrumb title={"Cadastrar"} pages={["Cadastrar"]} />
          ...
          <div className="max-w-[570px] w-full mx-auto rounded-xl bg-white shadow-1 p-4 sm:p-7.5 xl:p-11">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-5.5">
                <label className="block mb-2.5">
                  Confirmar senha <span className="text-red">*</span>
                </label>
            ...
            <button
              type="button"
              className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-gray-1 p-3 mt-5 ease-out duration-200 hover:bg-gray-2 w-full"
            >
              <svg
                width="20"
                height="20"
            ...
            <button
              type="button"
              className="flex justify-center items-center gap-3.5 rounded-lg border border-gray-3 bg-gray-1 p-3 mt-3 ease-out duration-200 hover:bg-gray-2 w-full"
            >
              <svg
                width="22"
                height="22"
            ...
            <p className="text-center mt-6">
              ...
              <Link
                href="/signin"
                className="text-dark hover:text-primary pl-2"
              >
                Entrar agora
              </Link>
            </p>
